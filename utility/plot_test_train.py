...
Basic script to plot the predicted microstructure (inference) before fine tuning the model, after tuning the model (inference), and the results of the ensemble (training or "true")
"""
import numpy as np
